...
public class HotelTest {
      ...
      while (true) {
         ...
         switch (choice) {
            ...
            case 4: // 업무종료
               ...
               System.out.println("   호텔문을 닫았습니다. 안녕히가십시오.         ");
               System.out.println("*************************************************");
               return;
            default : 
   ...
   private void checkOut() {
      ...
      //입력한 방번호의 객실에 손님이 있는지 검사
         ...
         //체크아웃은 해당 객실의 투숙객 이름을 null로 반환
         String name = hotelMap.get(num).getGuestName();//현재투숙객이름
         
         hotelMap.get(num).setGuestName(null);
          System.out.println(name+"님이 "+num+"호 객실에서 체크아웃 했습니다.");
   ...
   private void roomState() {
      //방번호를 순서대로 나오게 하기 위해서 방번호만 List에 넣은 후 정렬하여 사용
   ...
   private void checkIn() {
      ...
      //입력한 방번호가 Map의  Key값으로 없으면 잘못 입력한 방번호 
      if(!hotelMap.containsKey(num)) {
         System.out.println(num+"호 객실은 존재하지 않습니다.");
         return;
      }
      ...
      System.out.println(name+"님의 " +num +"호 체크인이 완료되었습니다.");
   }
