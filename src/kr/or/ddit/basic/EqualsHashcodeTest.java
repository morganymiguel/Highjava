...
public class EqualsHashcodeTest {
	...
	public static void main(String[] args) {
		 ...
		 * 메서드 - HashSet, Hashtable, HashMap과 같이 Hash로 시작하는 컬렉션객체들은 객체의 의미상 동일성을 비교하기
		 * 위해서 hashCode() 메서드를 호출하여 비교한다. 그러므로, 객체가 같은지 여부를 결정하려면 hashCode()메서드를 재정의
		 * 해야한다.
		 * 
		...
		HashMap<String, Person> testMap = new HashMap<>();
		testMap.put("홍길동", p1);
		...
		// 이몽룡 정보 출력하기
		// testMap.get("이몽룡")을 하면 주소값이 들어온다. 그래서 Person타입의 p5변수를 선언해서 주소를 지정해주면
		// 그 안의 데이터들이 전부 들어가게 된다.
...
//	@Override
//	public boolean equals(Object obj) {//오브젝트로 받는 다는 거는 아무 객체나 다 받는다.
